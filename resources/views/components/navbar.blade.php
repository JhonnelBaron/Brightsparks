<nav class=" fixed top-0 left-0 right-0 z-[1000] bg-blue-900 border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="{{ route('welcome')}}" class="flex items-center space-x-2">
          ...
          <span class="text-md font-bold whitespace-nowrap text-yellow-300 hover:text-yellow-400">BRIGHTSPARKS MULTIPLE INTELLIGENCE SCHOOL INC.</span>
      </a>
          ...
          <li>
            ...
            <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                  <li>
                    <a href="/teacher/login" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"> <i class="fa-solid fa-chalkboard-user px-2 "></i> Teacher</a>
                  </li>
