                ...
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4  md:flex-row md:space-x-8 md:mt-0 md:border-0  ">
                    ...
                    <li>
                        <a href="{{ route('aboutus') }}"
                            class=" block py-2 pl-3 pr-4 text-gray-100  md:hover:text-yellow-300   {{ Request::is('/aboutus') ? ' border-b-2 border-yellow-300' : '' }}">About
                            Us</a>
                    </li>
                    <li>
                        <a href="{{ route('contactus') }}"
                            class="border-b-2 border-yellow-300 block py-2 pl-3 pr-4 text-gray-100  md:hover:text-yellow-300   {{ Request::is('/contactus') ? ' border-b-2 border-yellow-300' : '' }}">Contact Us</a>
                    </li>
         ...
         <div class="mb-12 max-w-[570px] lg:mb-0">
            ...
            <div class="mb-8 flex w-full max-w-[370px]">
                <div
                   class="bg-primary/5 text-primary mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]"
                   >
                   <svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 320 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#232323}</style><path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"/></svg>
                </div>
                <div class="w-full">
                   <h4 class="mb-1 text-xl font-bold text-dark dark:text-white">
                      Facebook
                   </h4>
                   <a href="https://www.facebook.com/BrightSparksPH" target="_blank" class="text-base text-body-color dark:text-dark-6">
                    facebook.com/BrightSparksPH
                   </a>
                </div>
